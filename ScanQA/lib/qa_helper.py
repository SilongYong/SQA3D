...
# from https://github.com/MILVLG/mcan-vqa/blob/6b165e9a88800e2a09ece4645a3c8261938897c6/core/data/ans_punct.py
...
def normalize_answer_counter(answer_counter):
...
def normalize_answers_in_qa_data(records):
    normalized_records = []
